...
async def add_comment(
    ...
    public_value = public
    if public is False and visibility is not None:
        # Some MCP clients send omitted optional fields as "" plus false. In
        # that shape, preserve the Jira comments path and any visibility value.
        public_value = None
