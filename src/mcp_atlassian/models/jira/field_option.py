...
class JiraFieldOptionsResponse(ApiModel):
    ...
    @classmethod
    def from_api_response(cls, data: dict[str, Any], **kwargs: Any) -> "JiraFieldOptionsResponse":
...
class JiraFieldContextOptionsResponse(ApiModel):
    ...
    @classmethod
    def from_api_response(cls, data: dict[str, Any], **kwargs: Any) -> "JiraFieldContextOptionsResponse":
...
class JiraFieldContextsResponse(ApiModel):
    ...
    values: list[JiraFieldContext] = Field(
        description="List of field contexts"
    )

    @classmethod
    def from_api_response(cls, data: dict[str, Any], **kwargs: Any) -> "JiraFieldContextsResponse":
        ...
        if isinstance(values_data, list):
            for value_data in values_data:
                if value_data and isinstance(value_data, dict):
                    values.append(JiraFieldContext(
                        id=str(value_data.get("id", "")),
                        name=str(value_data.get("name", "")),
                        description=value_data.get("description"),
                        is_global_context=bool(value_data.get("isGlobalContext", False)),
                        is_any_issue_type=bool(value_data.get("isAnyIssueType", False))
                    ))
