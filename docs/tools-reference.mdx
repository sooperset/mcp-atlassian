...
| `confluence_comments` | Yes | `confluence_get_comments`, `confluence_add_comment`, `confluence_reply_to_comment`, `confluence_delete_comment`, `confluence_get_inline_comments`, `confluence_add_inline_comment` |
