...
description: "Overview of all 88 MCP tools for Jira and Confluence — organized by category with quick links"
---

MCP Atlassian provides **88 tools** for interacting with Jira and Confluence. Tools are organized by category below.
