...
description: "Overview of all 97 MCP tools for Jira and Confluence — organized by category with quick links"
---

MCP Atlassian provides **97 tools** for interacting with Jira and Confluence. Tools are organized by category below.
...
| `jira_links` | No | `jira_get_link_types`, `jira_link_to_epic`, `jira_unlink_from_epic`, `jira_create_issue_link`, `jira_create_remote_issue_link`, `jira_remove_issue_link` |
