...
description: "Overview of all 83 MCP tools for Jira and Confluence — organized by category with quick links"
---

MCP Atlassian provides **83 tools** for interacting with Jira and Confluence. Tools are organized by category below.
...
| Toolset | Core | Tools |
|---------|:----:|-------|
| `jira_issues` | Yes | `jira_get_issue`, `jira_search`, `jira_get_project_issues`, `jira_create_issue`, `jira_update_issue`, `jira_assign_issue`, `jira_delete_issue`, `jira_move_issue`, `jira_batch_create_issues`, `jira_batch_get_changelogs` |
...
| `jira_projects` | No | `jira_get_all_projects`, `jira_search_projects`, `jira_get_project_versions`, `jira_get_project_components`, `jira_get_project_fields`, `jira_create_version`, `jira_batch_create_versions`, `jira_update_version` |
