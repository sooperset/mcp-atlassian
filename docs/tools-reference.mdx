...
description: "Overview of all 115 MCP tools for Jira and Confluence — organized by category with quick links"
---

MCP Atlassian provides **115 tools** for interacting with Jira and Confluence. Tools are organized by category below.
...
| `jira_comments` | Yes | `jira_add_comment`, `jira_edit_comment`, `jira_get_comments`, `jira_delete_comment` |
| `jira_transitions` | Yes | `jira_get_transitions`, `jira_transition_issue` |
| `jira_projects` | No | `jira_get_project_issue_types`, `jira_get_create_fields`, `jira_get_project_versions`, `jira_get_project_components`, `jira_get_all_projects`, `jira_search_projects`, `jira_get_project_fields`, `jira_create_version`, `jira_batch_create_versions`, `jira_update_version`, `jira_get_project`, `jira_get_priorities`, `jira_get_resolutions`, `jira_get_statuses`, `jira_get_project_statuses` |
| `jira_agile` | No | `jira_get_agile_boards`, `jira_get_board_issues`, `jira_get_sprints_from_board`, `jira_get_sprint_issues`, `jira_create_sprint`, `jira_update_sprint`, `jira_add_issues_to_sprint`, `jira_move_issues_to_backlog`, `jira_get_sprint` |
| `jira_links` | No | `jira_get_link_types`, `jira_link_to_epic`, `jira_create_issue_link`, `jira_create_remote_issue_link`, `jira_remove_issue_link`, `jira_get_epic_issues` |
...
| `jira_users` | No | `jira_get_user_profile`, `jira_search_assignable_users`, `jira_search_users`, `jira_get_current_user` |
...
| `confluence_labels` | No | `confluence_get_labels`, `confluence_add_label`, `confluence_remove_label` |
