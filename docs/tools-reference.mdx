...
description: "Overview of all 82 MCP tools for Jira and Confluence — organized by category with quick links"
---

MCP Atlassian provides **82 tools** for interacting with Jira and Confluence. Tools are organized by category below.
...
<CardGroup cols={2}>
  ...
  <Card title="Service Desk" icon="headset" href="/docs/tools/jira-service-desk">
    Queues, request types, and customer request lifecycle
  </Card>
...
| `jira_service_desk` | No | `jira_get_service_desk_for_project`, `jira_get_service_desk_queues`, `jira_get_queue_issues`, `jira_get_request_types`, `jira_get_request_type_fields`, `jira_create_service_desk_request`, `jira_get_service_desk_request`, `jira_add_request_participants`, `jira_get_request_status`, `jira_get_request_transitions`, `jira_transition_service_desk_request`, `jira_attach_service_desk_request_files` |
