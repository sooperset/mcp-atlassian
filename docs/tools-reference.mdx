...
| `jira_service_desk` | No | `jira_get_service_desk_for_project`, `jira_get_service_desk_queues`, `jira_get_queue_issues`, `jira_get_request_types`, `jira_get_request_type_fields`, `jira_create_customer_request`, `jira_get_customer_request`, `jira_search_customer_requests`, `jira_get_customer_request_comments`, `jira_get_customer_request_statuses`, `jira_get_customer_request_transitions` |
