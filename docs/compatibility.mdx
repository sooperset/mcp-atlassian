...
| `jira_create_service_desk_request` and related customer request tools | Yes | Yes | Requires Jira Service Management. Includes `jira_get_request_types`, `jira_get_request_type_fields`, `jira_get_service_desk_request`, `jira_add_request_participants`, `jira_get_request_status`, `jira_get_request_transitions`, `jira_transition_service_desk_request`, `jira_attach_service_desk_request_files` |
