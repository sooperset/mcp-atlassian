...
Encrypted private keys aren't supported by the requests library. Decrypt the key before starting MCP Atlassian, and don't set `JIRA_CLIENT_KEY_PASSWORD` or `CONFLUENCE_CLIENT_KEY_PASSWORD`.
