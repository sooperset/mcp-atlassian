...
async def test_jira_tools_completeness():
    ...
    # Check if fastmcp_tools is iterable
    if hasattr(fastmcp_tools, "__iter__"):
        try:
...
async def test_jira_tools_parameters_match():
    ...
    async with client as connected_client:
        ...
        for tool_name, original_tool in original_jira_tools.items():
            ...
            fastmcp_params = fastmcp_tool.parameters.get("properties", {})
            ...
            fastmcp_required = set(fastmcp_tool.parameters.get("required", []))
