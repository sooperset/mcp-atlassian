...
from tests.utils.mocks import MockEnvironment, MockAtlassianClient
...
def validate_test_environment():
    ...
    try:
        from tests.utils import factories, mocks, base
        from tests.fixtures import jira_mocks, confluence_mocks
