...
from .factories import AuthConfigFactory, JiraIssueFactory, ConfluencePageFactory
...
class MockAtlassianClient:
    ...
    def create_confluence_client(**response_overrides):
        ...
        client.get_all_pages_from_space.return_value = responses["get_all_pages_from_space"]
...
class MockFastMCP:
    ...
    @staticmethod
    def create_request(state_data: Optional[Dict[str, Any]] = None):
