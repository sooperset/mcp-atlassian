...
class TestPropertiesMixin:
    ...
    def test_get_all_properties_success(self, properties_mixin):
        ...
        properties_mixin.confluence.get.return_value = api_response

        result = properties_mixin.get_content_properties(page_id)

        properties_mixin.confluence.get.assert_called_once_with(
    ...
    def test_get_all_properties_empty(self, properties_mixin):
        properties_mixin.confluence.get.return_value = {"results": []}
    ...
    def test_get_single_property_api_error(self, properties_mixin):
        properties_mixin.confluence.get.side_effect = RuntimeError(
    ...
    def test_get_single_property_url_encodes_key(self, properties_mixin):
        properties_mixin.confluence.get.return_value = {
            "key": "app/key",
            "value": {"enabled": True},
        }

        properties_mixin.get_content_properties("123456789", key="app/key")

        properties_mixin.confluence.get.assert_called_once_with(
            "https://example.atlassian.net/wiki/rest/api/content/"
            "123456789/property/app%2Fkey",
            absolute=True,
        )
    ...
    def test_set_property_creates_when_not_exists(self, properties_mixin):
        ...
        properties_mixin.confluence.get.return_value = get_resp
        properties_mixin.confluence.post.return_value = post_resp.json()

        result = properties_mixin.set_content_property(page_id, key, value)

        properties_mixin.confluence.post.assert_called_once_with(
    ...
    def test_set_property_updates_existing(self, properties_mixin):
        ...
        properties_mixin.confluence.get.return_value = get_resp
        properties_mixin.confluence.put.return_value = put_resp.json()

        result = properties_mixin.set_content_property(page_id, key, new_value)

        properties_mixin.confluence.put.assert_called_once_with(
            f"https://example.atlassian.net/wiki/rest/api/content/{page_id}/property/{key}",
            data={"key": key, "value": new_value, "version": {"number": 3}},
            absolute=True,
        )
    ...
    def test_set_property_version_starts_at_1_when_missing(self, properties_mixin):
        ...
        call_kwargs = properties_mixin.confluence.put.call_args
        assert call_kwargs.kwargs["data"]["version"]["number"] == 1
    ...
    def test_set_property_api_error_on_put(self, properties_mixin):
        ...
        properties_mixin.confluence.get.return_value = get_resp
        properties_mixin.confluence.put.side_effect = RuntimeError("Version conflict")
    ...
    def test_set_property_api_error_on_post(self, properties_mixin):
        ...
        get_resp = _make_response(404, {"message": "Not found"})
        properties_mixin.confluence.get.return_value = get_resp
        properties_mixin.confluence.post.side_effect = RuntimeError("Bad request")
