...
class TestFormsMixin(unittest.TestCase):
    ...
    def setUp(self, mock_from_env):
        ...
        mock_jira_forms = MagicMock()
        self.mixin = FormsMixin(config=mock_config, jira_forms=mock_jira_forms)

    def test_get_form(self):
        """Test get_form method."""
        self.mixin.jira_forms.get.return_value = {"id": "123", "name": "Test Form"}
        form = self.mixin.get_form("123")
        self.mixin.jira_forms.get.assert_called_with("form/123")
    ...
    def test_get_issue_forms(self):
        ...
        self.mixin.jira_forms.get.assert_called_with("issue/PROJ-1/form")
        self.assertEqual(len(forms), 1)

    def test_submit_form(self):
        """Test submit_form method."""
        answers = {"question_1": "answer_1"}
        self.mixin.jira_forms.post.return_value = {"success": True}
        result = self.mixin.submit_form("PROJ-1", "123", answers)
        self.mixin.jira_forms.post.assert_called_with(
    ...
    def test_get_form_answers(self):
        ...
        self.mixin.jira_forms.get.return_value = {
            "id": "123",
            "answers": {"question_1": "answer_1"},
        }
        form = self.mixin.get_form_answers("PROJ-1", "123")
        self.mixin.jira_forms.get.assert_called_with("issue/PROJ-1/form/123")
    ...
    def test_attach_form(self):
        ...
        self.mixin.jira_forms.post.return_value = {
            "id": "456",
            "issueKey": "PROJ-1",
            "status": "attached",
        }
    ...
    def test_change_form_visibility(self):
        ...
        self.mixin.jira_forms.put.return_value = {"success": True}
        result = self.mixin.change_form_visibility("PROJ-1", "123", "external")
        self.mixin.jira_forms.put.assert_called_with(
    ...
    def test_reopen_form(self):
        ...
        self.mixin.jira_forms.post.assert_called_with("issue/PROJ-1/form/123/reopen")
        self.assertTrue(result["success"])
    ...
    def test_get_form_simplified_answers(self):
        ...
        self.mixin.jira_forms.get.assert_called_with("issue/PROJ-1/form/123/answers")
    ...
    def test_get_project_form_templates(self):
        ...
        self.mixin.jira_forms.get.assert_called_with("project/PROJ/form")
        self.assertEqual(len(result["templates"]), 1)

    def test_get_project_form_template(self):
        """Test get_project_form_template method."""
        self.mixin.jira_forms.get.return_value = {"id": "123", "name": "Test Template"}
        result = self.mixin.get_project_form_template("PROJ", "123")
        self.mixin.jira_forms.get.assert_called_with("project/PROJ/form/123")
        self.assertEqual(result["name"], "Test Template")

    def test_export_form_template(self):
        """Test export_form_template method."""
        self.mixin.jira_forms.get.return_value = {"id": "123", "export_data": "test"}
        result = self.mixin.export_form_template("PROJ", "123")
        self.mixin.jira_forms.get.assert_called_with("project/PROJ/form/123/export")
    ...
    def test_create_project_form_template(self):
        ...
        self.mixin.jira_forms.post.return_value = {"id": "456", "success": True}
        result = self.mixin.create_project_form_template("PROJ", template_data)
        self.mixin.jira_forms.post.assert_called_with(
            "project/PROJ/form", json=template_data
        )
        self.assertTrue(result["success"])
    ...
    def test_update_project_form_template(self):
        ...
        self.mixin.jira_forms.put.return_value = {"id": "123", "success": True}
    ...
    def test_delete_project_form_template(self):
        ...
        self.mixin.jira_forms.delete.return_value = {"success": True}
        result = self.mixin.delete_project_form_template("PROJ", "123")
        self.mixin.jira_forms.delete.assert_called_with("project/PROJ/form/123")
        self.assertTrue(result["success"])
